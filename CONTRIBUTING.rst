...
new TosKer could always use more documentation, whether as part of the
official new TosKer docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
2. If the pull request adds functionality, the docs should be updated. Put
   ...
   feature to the list in DESCRIPTION.rst.
3. The pull request should work for Python 2.6, 2.7, 3.3, 3.4, 3.5, 3.6 and for PyPy. Check
   https://travis-ci.org/lucarin91/TosKer/pull_requests
